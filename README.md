...
- ค้นหาข่าวเก่าจากคลังทั้งหมด กรองสถานะอ่านแล้ว และทำเครื่องหมายอ่านทั้งหมด
- Dark mode และติดตั้งบน Home Screen ได้
- เก็บรายการข่าวล่าสุดไว้ใน IndexedDB สำหรับเปิดดู snapshot ตอนออฟไลน์
- จัดคิวดึง RSS ทุก 5 นาทีด้วย Cloudflare Cron Trigger พร้อม conditional fetch และ backoff เมื่อแหล่งข่าวมีปัญหา
- โหลดเนื้อหาเต็มพร้อมรูปจากหน้าเว็บหรือ RSS ของแหล่งข่าวที่รองรับ และแคชไว้ใช้ข้ามอุปกรณ์
- ปรับขนาดตัวอักษรบทความแยกกันในแต่ละอุปกรณ์
- กดปุ่มลูกศรลงหรือลูกศรขวาเพื่อเปิดอ่านข่าวถัดไปทันที
...
ทุกอุปกรณ์จะตรวจข้อมูลใหม่ทันทีเมื่อกลับมาเปิดหน้าเว็บ ขณะใช้งานจะซิงก์เฉพาะข้อมูลที่เปลี่ยนทุก 2 นาที และหยุด polling เมื่อหน้าเว็บไม่ได้อยู่เบื้องหน้า
